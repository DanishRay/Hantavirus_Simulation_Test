...
# Chemokine Grid Settings (Low res for performance)
GRID_SIZE = 10 
...
CHEMO_COLOR = (100, 100, 255) # Blue glow for CXCL10
...
class ChemotacticTCell:
    ...
    def update(self, chem_grid):
        ...
        # 1. Sensing the Gradient (Simple finite difference)
        # Check concentration North, South, East, West
        try:
        ...
        # 2. Biased Random Walk Equation
        # v = random_walk + alpha * gradient
...
class Simulation:
    ...
    def diffuse_chemokines(self):
        # Laplacian Diffusion: Center loses, neighbors gain
        new_grid = self.chem_grid * (1 - DECAY_RATE)
        # Simple 4-way diffusion approximation
